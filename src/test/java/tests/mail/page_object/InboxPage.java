...
import patterns.decorator.InformalLetterDecorator;
...
public class InboxPage extends AbstractPage{
    ...
    private Letter firstLetter = new Letter("oralkhanova.zhadyra@gmail.com","Email from Selenium WebDriver","Hello, this email was send by the work of Selenium Webdriver");
    InformalLetterDecorator informalLetterDecorator = new InformalLetterDecorator(firstLetter);
